...
const products: Product[] = [
  ...
  },
  {
    ...
    grade: "Classic Grade",
    description:
      "Classic split moth dal — slightly coarser split with full earthy flavour intact. Popular in Maharashtra for traditional dals and usal.",
  ...
  },
  {
    ...
    grade: "Premium Grade",
    description:
      "Premium split moth dal — finest selection of split moth beans with superior protein content and minimal foreign matter.",
  ...
  },
  {
    ...
    grade: "Premium Grade",
    description:
      "Our signature premium toor dal. Bright golden-yellow split pigeon peas, machine-cleaned, lightly oiled for longer shelf life.",
  ...
  },
  {
    ...
    grade: "Super Grade",
    description:
      "Super-grade, un-oiled toor dal with a natural golden hue and rich aroma. Prized by connoisseurs for everyday and festive cooking.",
  ...
  },
  {
    ...
    grade: "Super Grade",
    description:
      "Our flagship urad dal — exceptional uniformity, premium split quality, and white dhuli dal ideal for idli, dosa and vada.",
  ...
  },
  {
    ...
    description:
      "Machine-polished split Bengal gram with a bright golden-yellow finish. Uniform size and superior texture after cooking.",
  ...
  },
  {
    ...
    grade: "Kori Grade",
    description:
      "Unpolished split Bengal gram with its natural bran intact. Rustic appearance, earthy flavour, and higher fibre content.",
  ...
  },
  {
    ...
    grade: "Kori Grade",
    description:
      "A preferred unpolished chana dal known for its traditional flavour profile. Widely used in Maharashtra for dals and snacks.",
    specs: ["Protein: 20g/100g", "Fibre: 10g/100g", "Moisture: <11%"],
    rating: 4.6,
  },
  {
